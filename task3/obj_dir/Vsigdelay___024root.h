...
class Vsigdelay___024root final : public VerilatedModule {
  public:
    ...
    VL_IN16(incr,8,0);
    VL_IN16(offset,8,0);
    SData/*8:0*/ sigdelay__DOT__write_address;
    SData/*8:0*/ sigdelay__DOT__read_address;
    SData/*8:0*/ sigdelay__DOT____Vcellout__delayram__dout;
    VlUnpacked<SData/*8:0*/, 256> sigdelay__DOT__delayram__DOT__ram_array;
