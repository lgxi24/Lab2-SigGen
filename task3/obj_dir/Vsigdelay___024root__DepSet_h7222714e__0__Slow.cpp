...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->sigdelay__DOT__write_address = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT__read_address = VL_RAND_RESET_I(9);
    vlSelf->sigdelay__DOT____Vcellout__delayram__dout = VL_RAND_RESET_I(9);
    for (int __Vi0=0; __Vi0<256; ++__Vi0) {
        vlSelf->sigdelay__DOT__delayram__DOT__ram_array[__Vi0] = VL_RAND_RESET_I(9);
    }
